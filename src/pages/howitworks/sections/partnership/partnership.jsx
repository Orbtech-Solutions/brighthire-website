...
export default function Partnership() {
    return(
        <section className="whole-section">
            <div className="section-inner section-partnership">
                <Card heading={<Heading smallText="In partnership with" heading="Work 4 A Living"/>} body="W4AL is a South African non-profit transforming lives through mentorship, skills development and biblical values. 
